                        ...
                        while True:
                            ...
                            if sub_choice == '1':
                                ...
                                if len(selected_tournament.players) < 2:
                                    ...
                                    if str(round_number) in selected_tournament.results and selected_tournament.results[str(round_number)]:
                                        ...
                                        if edit_choice == 'y':
                                            ...
                                            while True:
                                                ...
                                                if 0 <= match_index < len(matches):
                                                    ...
                                                    tournament_controller.edit_results(selected_tournament.name, round_number, match_index, new_result)
                                                    break
                                        ...
                                        for match_index, match in enumerate(matches):
                                            while True:
                                                ...
                                                tournament_controller.enter_results(selected_tournament.name, round_number, [match_results])
                                                break
